...
export const ui = {
  en: {
    ...
    'about.1': 'My name is Mateo Ledesma, I\'m 24 years old, and I\'m a Frontend Developer with 2 years of professional experience. I started my journey in software development back in 2015 as a self-taught learner, honing my skills in frontend technologies like JavaScript, React, and Next.js.',
    'about.2': 'Currently, I work full-time as a Frontend Developer, focusing on building efficient and modern web interfaces. Additionally, I\'m expanding my knowledge in backend technologies such as Go, C#, and Node.js, allowing me to understand and collaborate on full-stack solutions when needed.',
    'project.open': 'Demo',
  ...
  es: {
    ...
    'about.1': 'Me llamo Mateo Ledesma, tengo 24 años y soy Frontend Developer con 2 años y medio de experiencia profesional. Comencé en el desarrollo de software en 2015 de manera autodidacta, aprendiendo y perfeccionándome en tecnologías frontend como JavaScript, React y Next.js.',
    'about.2': 'Actualmente, trabajo a tiempo completo como Desarrollador Frontend, enfocándome en construir interfaces web eficientes y modernas. Además, amplío mis conocimientos en backend con tecnologías como Go, C# y Node.js, lo que me permite comprender y colaborar en soluciones full stack cuando es necesario.',
    'project.open': 'Demo',
