...
export const ui = {
  en: {
    ...
    'about.2': 'I\'m always looking to grow professionally, and I\'m expanding my skills in the Backend using Go and C#.',
    'project.open': 'Demo',
  ...
  es: {
    ...
    'about.2': 'Estoy en constante crecimiento profesional y ampliando mis habilidades en el Backend utilizando Go y C#.',
    'project.open': 'Demo',
