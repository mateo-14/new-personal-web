...
export const ui = {
  en: {
    ...
    'about.2': 'I\'m always looking to grow professionally, and I\'m expanding my skills in the Backend, using languages like Go and C#.',
  ...
  es: {
    ...
    'about.2': 'Estoy en constante crecimiento profesional y ampliando mis habilidades en el Backend, utilizando lenguajes como Go y C#.',
